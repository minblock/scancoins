# Support for Output Descriptors in scancoins Core

Since scancoins Core v0.17, there is support for Output Descriptors. This is a
...
on scancoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing scancoins Core wallets, a convenience function `combo` is
