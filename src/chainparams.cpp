...
{
    const char* pszTimestamp = "4/8/2020 Provigen Networks: Just because all my tips are desynchronyzed!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586340909, 1584139, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x22054cb39fe237f464300d1540b1e4a79e73a32484d6e18a203f91bf2b03ba5c"));
        assert(genesis.hashMerkleRoot == uint256S("0x792bc55ef7cfce36cead58ece92323f184dde8422a50e481893575f6b08f7d83"));
        ...
        vSeeds.emplace_back("seed-a.scancoins.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.scancoinstools.com");
        vSeeds.emplace_back("dnsseed.scancoinspool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 2113472, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf313fe595652328d55d9e9ad1e176a8d2b52b486a8e512612e1610ce7b3d09ab"));
        assert(genesis.hashMerkleRoot == uint256S("0x792bc55ef7cfce36cead58ece92323f184dde8422a50e481893575f6b08f7d83"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.scancoinstools.com");
        vSeeds.emplace_back("seed-b.scancoins.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcf353ce91e84f9c16d387daaedfd5d4a496fc7a26964b1a0a834ab255f8bb80d"));
        assert(genesis.hashMerkleRoot == uint256S("0x792bc55ef7cfce36cead58ece92323f184dde8422a50e481893575f6b08f7d83"));
