...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The scancoins Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "scancoins Core"
...
#define PACKAGE_BUGREPORT "https://github.com/scancoins-project/scancoins/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "scancoins Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "scancoins Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "scancoins"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://scancoins.org/"
