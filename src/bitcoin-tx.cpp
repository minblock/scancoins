...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " scancoins-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  scancoins-tx [options] <hex-tx> [commands]  Update hex-encoded scancoins transaction\n" +
            "or:     scancoins-tx [options] -create [commands]   Create hex-encoded scancoins transaction\n" +
            "\n";
