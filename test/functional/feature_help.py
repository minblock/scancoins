...
"""Verify that starting scancoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start scancoins with -h for help text")
        ...
        self.log.info("Start scancoins with -version for version information")
        ...
        self.log.info("Start scancoinsd with -fakearg to make sure it does not start")
