...
pkgdatadir = $(datadir)/scancoins
pkgincludedir = $(includedir)/scancoins
pkglibdir = $(libdir)/scancoins
pkglibexecdir = $(libexecdir)/scancoins
...
ACLOCAL = ${SHELL} /scancoins/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /scancoins/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /scancoins/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /scancoins/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = scancoins-cli
BITCOIN_DAEMON_NAME = scancoinsd
BITCOIN_GUI_NAME = scancoins-qt
BITCOIN_TX_NAME = scancoins-tx
BITCOIN_WALLET_TOOL_NAME = scancoins-wallet
...
COPYRIGHT_HOLDERS_FINAL = The scancoins Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = scancoins Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /scancoins/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = scancoins
PACKAGE_BUGREPORT = https://github.com/scancoins-project/scancoins/issues
PACKAGE_NAME = scancoins Core
PACKAGE_STRING = scancoins Core 0.18.1
PACKAGE_TARNAME = scancoins
PACKAGE_URL = https://scancoins.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /scancoins
abs_srcdir = /scancoins
abs_top_builddir = /scancoins
abs_top_srcdir = /scancoins
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /scancoins/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/scancoins-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/scancoins-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/scancoins-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/scancoins-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
